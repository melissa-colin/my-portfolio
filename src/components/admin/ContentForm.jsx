...
const ContentForm = ({ id, type: initialType = 'project', language = 'en', onSuccess }) => {
  ...
  const validateForm = () => {
    ...
    if (['project', 'certification', 'publication', 'blog'].includes(formData.type) && !formData.description.trim()) {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
      ...
      <form onSubmit={handleSubmit}>
        ...
        {/* Description */}
        {(['project', 'certification', 'publication', 'blog'].includes(formData.type)) && (
          <div className="mb-6">
        ...
        {/* Technologies */}
        {(['project', 'certification'].includes(formData.type)) && (
          <div className="mb-6">
        ...
        {/* Links */}
        {['project', 'certification', 'publication'].includes(formData.type) && (
          <div className="mb-6">
