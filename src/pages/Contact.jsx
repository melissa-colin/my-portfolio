...
import { FiMail, FiMapPin, FiSend, FiPhone, FiLinkedin, FiGithub } from 'react-icons/fi';
...
const Contact = () => {
  ...
  // Handle form submission (ENVOI AU BACKEND)
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        setSubmitStatus({
          success: true,
          message: result.message || t('contact.messageSent')
        });
        setFormData({
          name: '',
          email: '',
        ...
        setSubmitStatus({
          success: false,
          message: result.error || t('contact.error')
        });
      }
    } catch (error) {
      setSubmitStatus({
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="ml-4">
                          ...
                          <p className="mt-1 text-gray-600 dark:text-gray-400">
                            <a href={`mailto:${t('contact.emailAddress')}`} className="hover:text-red-600 dark:hover:text-red-500">
